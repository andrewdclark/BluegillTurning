...
maindata %>% bodyTracesPlot('BG63_14_8', 4) + scale_x_reverse() + coord_cartesian(xlim = c(264, 242), ylim = c(2495, 2505))
ggsave('FastTurnBodyTrace.jpg', path = here("ProcessedData/Figures/"), width = 3.25, height = 2, dpi = 300)
maindata %>% bodyTracesPlot('BG63_17_5', 4) + scale_x_reverse() + coord_cartesian(xlim = c(242, 264), ylim = c(2495, 2505))
